...
# Define the base directory for relative file paths.
...
# --------------------------------------------------
# Traded Players List and Functions
# --------------------------------------------------
TRADED_PLAYERS = {
    "kyle kuzma": "MIL"
...
def analyze_nhl_psp(file_path, stat_key):
    ...
    # Standardize header names: strip whitespace and uppercase.
